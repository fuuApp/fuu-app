...
const APP_STORE_URL = 'https://apps.apple.com/jp/app/fuu-%E3%81%B5%E3%81%85/id6791250026'
const GOOGLE_PLAY_URL = '#'    // Google Play URL（準備中）
        ...
        {!isNative() && <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10, marginBottom: 16 }}>
          ...
          >
            ...
            <div style={{ textAlign: 'left', lineHeight: 1.3 }}>
              <div style={{ fontSize: 10, opacity: 0.75 }}>Download on the</div>
