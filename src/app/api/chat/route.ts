...
1. まず感情を否定せず受け止める（1〜2文。「そこまで追い詰められてるんだね」「話してくれてよかった」など）
2. 次の文を必ず含める→「つらいとき、話を聞いてくれる場所として、よりそいホットライン（0120-279-338、24時間・無料）もあるよ。」
3. 「今どんな気持ちか、もう少し話してくれる？」で締める
...
キャラクターの口調は維持しながら、上記3ステップを必ず実行する。
` : ''
