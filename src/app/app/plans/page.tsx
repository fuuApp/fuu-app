          ...
          <div style={{ width:'100%',maxWidth:480,background:'#fff',borderRadius:'20px 20px 0 0',padding:'28px 24px 44px',boxShadow:'0 -4px 20px rgba(0,0,0,0.15)' }}>
            ...
            {isUpgrade && (
              <>
                ...
                <p style={{ fontSize:15,color:'#e53935',textAlign:'center',margin:'0 0 10px',lineHeight:1.6,fontWeight:700 }}>
                  ⚠️ 変更後は必ず画面上部の「fuu ふぅに戻る」を<br />タップしてアプリに戻ってください。<br />他のボタンは押さないでください。
                </p>
              </>
            )}
