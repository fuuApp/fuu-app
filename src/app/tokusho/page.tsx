        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
          <tbody>
            {[
              ...
              ['支払い方法', '【Webブラウザ版】クレジットカード（Visa・Mastercard・American Express・JCB）・Apple Pay・Google Pay（Stripe経由）\n【iOSアプリ版】App Store経由（Apple Inc.）\n【Androidアプリ版】Google Play経由（Google LLC）'],
              ['支払い時期', '月額プラン：登録月より毎月自動更新\nチケット：購入時に即時決済'],
              ['サービス提供時期', '決済完了後、即時提供'],
              ['解約・キャンセル方法', '【Webブラウザ版】アプリ内の設定ページ→「プラン・解約」から手続き可能\n【iOSアプリ版】App Store（設定→Apple ID→サブスクリプション）から手続き可能\n【Androidアプリ版】Google Play（マイアプリ→サブスクリプション）から手続き可能\n解約後は次回更新日まで利用可能。日割り返金なし\nチケットは購入後24時間以内・未使用の場合のみ返金対応'],
